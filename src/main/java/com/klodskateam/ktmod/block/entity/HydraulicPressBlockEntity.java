...
public class HydraulicPressBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public HydraulicPressBlockEntity(BlockPos position, BlockState state) {
		super(KtmodModBlockEntities.HYDRAULIC_PRESS.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return new TextComponent("hydraulic_press");
	}
