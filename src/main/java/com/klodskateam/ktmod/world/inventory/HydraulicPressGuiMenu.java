...
public class HydraulicPressGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public HydraulicPressGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(KtmodModMenus.HYDRAULIC_PRESS_GUI, id);
