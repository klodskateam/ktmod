...
public class SmelterGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SmelterGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(KtmodModMenus.SMELTER_GUI, id);
