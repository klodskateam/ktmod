...
package com.klodskateam.ktmod.world.inventory;
...
import com.klodskateam.ktmod.init.KtmodModMenus;

public class SolderingStationGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SolderingStationGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(KtmodModMenus.SOLDERING_STATION_GUI, id);
		...
		this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 16, 53) {
		}));
		this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 52, 53) {
		}));
		this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 97, 53) {
		}));
		this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 142, 35) {
			@Override
