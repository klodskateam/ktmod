...
public class TankGUIScreen extends AbstractContainerScreen<TankGUIMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("ktmod:textures/screens/tank_gui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		}.getFluidTankLevel(new BlockPos((int) x, (int) y, (int) z), 1)) + "/100000", 6, 61, -6711040);
	}
