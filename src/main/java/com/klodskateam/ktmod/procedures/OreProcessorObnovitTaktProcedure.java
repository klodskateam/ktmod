...
public class OreProcessorObnovitTaktProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((new Object() {
		...
		}.getItemStack(world, new BlockPos(x, y, z), 0)).getItem() == KtmodModItems.FUEL_BUCKET.get()) {
			if (new Object() {
			...
			}.getFluidTankLevel(world, new BlockPos(x, y, z), 1) <= 9000) {
				{
		...
		}.getItemStack(world, new BlockPos(x, y, z), 2)).getItem() == KtmodModBlocks.URAN_ORE.get().asItem()) {
			if (new Object() {
				public int getFluidTankLevel(LevelAccessor level, BlockPos pos, int tank) {
					AtomicInteger _retval = new AtomicInteger(0);
					BlockEntity _ent = level.getBlockEntity(pos);
				...
				}
				{
					...
					if (_ent != null) {
						final int _slotid = 3;
						final ItemStack _setstack = new ItemStack(KtmodModItems.PROCESSED_URANIUM.get());
						_setstack.setCount((int) (new Object() {
							public int getAmount(LevelAccessor world, BlockPos pos, int slotid) {
								AtomicInteger _retval = new AtomicInteger(0);
								BlockEntity _ent = world.getBlockEntity(pos);
		...
		}.getItemStack(world, new BlockPos(x, y, z), 2)).getItem() == Blocks.GRASS.asItem()) {
			if (new Object() {
				public int getFluidTankLevel(LevelAccessor level, BlockPos pos, int tank) {
					AtomicInteger _retval = new AtomicInteger(0);
					BlockEntity _ent = level.getBlockEntity(pos);
				...
				}
				{
					...
					if (_ent != null) {
						final int _slotid = 3;
						final ItemStack _setstack = new ItemStack(KtmodModItems.RUBBER.get());
						_setstack.setCount((int) (new Object() {
							public int getAmount(LevelAccessor world, BlockPos pos, int slotid) {
								AtomicInteger _retval = new AtomicInteger(0);
								BlockEntity _ent = world.getBlockEntity(pos);
						...
						}.getAmount(world, new BlockPos(x, y, z), 3) + 4));
						_ent.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null).ifPresent(capability -> {
							if (capability instanceof IItemHandlerModifiable)
								((IItemHandlerModifiable) capability).setStackInSlot(_slotid, _setstack);
						});
